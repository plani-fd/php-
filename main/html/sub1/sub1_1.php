<?php
	...
	# 공용 Libarary 로드
	include_once($_SERVER["DOCUMENT_ROOT"].'/main/html/include/library.php');

	# 서브 페이지 상단 html 로드
	include_once($_SERVER["DOCUMENT_ROOT"].'/main/html/include/sub_header.php');
?>
...
<?php
	# 서브 페이지 하단 html 로드
	include_once($_SERVER["DOCUMENT_ROOT"].'/main/html/include/sub_footer.php');
?>